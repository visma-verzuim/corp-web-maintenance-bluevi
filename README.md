# corp-web-maintenance-bluevi

Static "under maintenance" page for **BlueVi**.

## Purpose

This is a single, self-contained HTML file that is deployed in place of the
regular BlueVi website when the application needs to go **fully offline**
for major maintenance (e.g. infrastructure migrations, database upgrades).
...
- Layout, spacing, and structure are kept in sync with the sibling
  maintenance page for VerzuimSignaal (`corp-web-maintenance-vzs`) — only
